...
I could have gone with a typical Spotify-style layout — lots of cards, lots of features, the usual streaming app look. But my main idea was that the first few seconds should make someone want to explore further. So instead of adding lots of features, I focused on the homepage and made those first few seconds count. I went with a dark, slightly retro rock look, built around a strong hero section and a vinyl/stereo visual, and kept the layout simple so the design could stand out instead of getting lost in extra UI.


3. One trade-off you made under the time limit, and what you’d do with a real week.
...
5. Where did you use AI tools, and what did you personally verify or change afterward?
